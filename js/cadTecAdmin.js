document.addEventListener('DOMContentLoaded', () => {
      ...
      const especializacao = document.getElementById("areaEspecializacao");
      const nivel = document.getElementById("nivelExperiencia");
      ...
      especializacao.value = localStorage.getItem('especializacao') || '';
